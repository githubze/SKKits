...
#define kFontFix(a)          [UIFont fontWithName:@"PingFangSC-Regular" size:a]

/**
 平方中黑体
 */
#define kPfMidFont(a)          [UIFont fontWithName:@"PingFangSC-Medium" size:kAuto(a)]
#define kMidFontFix(a)          [UIFont fontWithName:@"PingFangSC-Medium" size:a]

/**
 平方粗体
 */
#define kPfBoldFont(a)          [UIFont fontWithName:@"PingFangSC-Bold" size:kAuto(a)]
#define kBoldFontFix(a)          [UIFont fontWithName:@"PingFangSC-Bold" size:a]
...
/**
 文字默认颜色
 */
#define KTextColor333   UIColorFromRGB(0x333333)
#define KTextColor666   UIColorFromRGB(0x666666)
#define KTextColor999   UIColorFromRGB(0x999999)
#define KTextColorfff   UIColorFromRGB(0xFFFFFF)
